...
<template>
  <edit-request-list
      :title="`Заявки на преподавателей`"
      :type-request="`teacher`"
      :edit-requests="editRequestsTeachers" />
  <edit-request-list
      :title="`Заявки на институты`"
      :type-request="`institutes`"
      :edit-requests="editRequestsInstitutes" />
</template>
